...
# Custom settings:
# ------------------------------------------------------------------------------
version, conda = [read_pythonic_config(p.join(src_dir, 'openfonts', var + '.py'), [var])[0]
...
spec = dict(
    ...
    hash_='91b3bffb7f33ea5fbc9fcf57b788565495af03e6cfd7951004cbd3cc63e239b7'
)
...
class PostInstallCommand(install):
    def run(self):
        ...
        move_contents(
            ...
            to=p.join(self.install_lib, 'openfonts', 'open-fonts'))
        install.run(self)
